...
from socket_tasks import app as celery_app 
...
class TaskBroker(threading.Thread):
    ...
    def __init__(self, client_data_ref, external_lock=None):
        super().__init__()
        self.running = True
        ...
        # Use external lock if provided, otherwise use internal one
        self.lock = external_lock if external_lock is not None else client_status_lock
